...
def test_auth_by_email_valid(auth_elements, button_exit, auth_tab):
    """Проверка авторизации по email с валидными данными"""
...
def test_auth_by_login_valid(auth_elements, button_exit, auth_tab):
    """Проверка авторизации по логину с валидными данными"""
...
def test_auth_by_ls_valid(auth_elements, button_exit, auth_tab):
    """Проверка авторизации по лицевому счёту с валидными данными"""
...
def test_auth_empty_value(auth_elements, error_message):
    """Проверка авторизации с пустыми полями для ввода"""
...
def test_auth_by_phone_invalid(auth_elements, error_message):
    """Проверка авторизации по номеру телефона с неавторизованным номером телефона"""
...
def test_auth_by_email_invalid(auth_elements, auth_tab, error_message):
    """Проверка авторизации по адресу электронной почты с неавторизованной почтой"""
...
def test_click_button_register(auth_elements, register_page):
    """Проверка кнопки 'Зарегистрироваться', переход на страницу регистрыции"""
...
def test_click_button_forgot_pass(auth_elements, recovery_pass_page):
    """Проверка кнопки 'Забыл пароль', переход на страницу восстановления пароля"""
